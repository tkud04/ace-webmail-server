    ...
    <div class="dashboard-main-wrapper">
       ...
       <div class="dashboard-header">
            <nav class="navbar navbar-expand-lg bg-white fixed-top">
                <a class="navbar-brand" href="<?php echo e(url('/')); ?>"> <img src="images/logo.png" style="width: 40px; height: 40px;"/></a>
                <button class="navbar-toggler"" type="button" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
                    <span class="navbar-toggler-icon toggler-white"></span>
                </button>
...
<?php /**PATH C:\bkupp\lokl\repo\ace-webmail-server\resources\views/layout.blade.php ENDPATH**/ ?>